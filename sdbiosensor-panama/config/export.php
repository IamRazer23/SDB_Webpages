...
return [
    ...
    'paths' => [
        ...
        'centro-de-medios',
        'soporte',
        // Páginas de detalle de producto (garantiza que todas se exporten,
        // incluso si el crawler no las enlaza desde alguna parte).
        'productos/covid-19-ag-home-test',
        'productos/iq-covid-flu-ag-combo',
        'productos/covid-flu-ag-combo',
        'productos/malaria-pf-ag',
        'productos/sars-cov-2-ag-fia',
        'productos/standard-prime-bg',
    ],
